...
public class Constant {
    ...
    //Mensajes para la cabecera qrID
    public static final String MESSAGE_QR_ID_NOT_BLANK
            = "La cabecera 'qrId' Es requerida.";

    public static final String MESSAGE_QR_ID_FORMAT_UUID_REQUIRED
            = "La cabecera 'qrId' Debe cumplir el formato UUID";

    //Mensajes para la cabecera qrCode
    public static final String MESSAGE_QR_CODE_NOT_BLANK
            = "La cabecera 'qrCode' Es requerida.";
